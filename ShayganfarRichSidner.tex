...
Our work is built on general notion of appraisal theory while it is focused on
...
research topic that has received much attention in the last decades
\cite{velasquez:emotions-motivations-agents,paiva:agent-care,scott:modeling-empathy-agent,pontier:women-robot-men}.
However, EMA or several other examples in artificial intelligence and robotics
...
The comoputational collaboration model in our work is closely influenced by the
SharedPlan theory \cite{grosz:plans-discourse}. However, our algorithms are also
compatible with other collaboration theories, e.g., Joint Intentions theory
...
combined, as they are done in our work. We believe a systematic integration of
collaboration theories with some theories like the appraisal theory can help us
to describe the underlying collaboration processes leading to the existing
