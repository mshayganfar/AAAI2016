...
\begin{itemize}
  ...
  algorithms.
  \item \textit{topLevelGoalStatus()}
  \item \textit{currGoalStatus()}
  \item \textit{precondStatus()}
  \item \textit{doesContribute()}
  \item \textit{extractContributingGoals()}
  \item \textit{extractPredecessors()}
  \item \textit{extractInputs()}
  \item \textit{isAvailable()}
  \item \textit{isAchieved()}
  \item \textit{isFocused()}
  \item \textit{getResponsible()}
\end{itemize}
