...
the acquired path. We consider maximum agency value (i.e., 1.0) if the robot
possesses an internal motive towards the recognized goal; otherwise we consider
the minimum agency value (i.e., 0.0). Note that the process of forming new
internal motives is out of this paper's context.
...
task the value of $\beta$ would be 0 or 1.
