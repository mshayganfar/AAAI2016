...
of emotions in a collaboration.
\end{quote}
\end{abstract}
...
Sousa in The Rationality of Emotion (\citeyear{sousa:rationality-emotion})
...
mental state. Finally, we describe the algorithms we developed to compute the
value of four crucial appraisal variables.
...
well as the anticipated mental states of the other (human). The
...
internal cognitive processes. We provide more details about the attributes of
beliefs and motives in this paper, since they are used in our appraisal
algorithms.
...
each turn which includes the recognized goal associated with the event and the
belief about the event. The goals can be associated with any type of event
including action, utterance, or emotional expression.
...
Our work is built on the general notion of appraisal theory while it is focused
on its application in human-robot collaboration. Computational appraisal models
have been applied to a variety of uses including contributions to psychology,
...
\cite{velasquez:emotions-motivations-agents,paiva:agent-care,scott:modeling-empathy-agent,pontier:women-robot-men}.
...
contexts
\cite{marsella:ema-process-model,kim:model-hri-appraisal,adam:bdi-emotional-companion,rosenbloom:sigma-appraisal}.

The computational collaboration model in our work is closely influenced by the
...
collaboration theories and some theories like appraisal theory can help us
describe the underlying collaboration processes leading to the existing
