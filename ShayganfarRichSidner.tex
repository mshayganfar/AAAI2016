...
\cite{marsella:computational-models}; we do not provide algorithms for them
...
robot. We present our first algorithm for determining the relevance of the given
...
\ref{sec:mental-states@cref}. The event will also include a corresponding goal
...
algorithms. Continuing in line 3, the $g_{t}$ represents the shared goal (in the
