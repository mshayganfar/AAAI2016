...
In algorithm \ref{alg:expectedness} we provide the process of expectedness based
on the shared plan and status of the shared goal. The key point in this
...
($\mathit{g}_{\varepsilon_t}$).  It receives the current mental graph,
$\mathcal{G}_{t}$, and the current event, $\varepsilon_t$, from input, and
decides whether the current event is expected. First,
